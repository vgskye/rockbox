...
/* uart0_rxd */
DEFINE_GPIO(BT_RXD_HW4,       GPIO_PC(10),    GPIOF_DEVICE(0b00))

/* uart0_txd */
DEFINE_GPIO(BT_TXD_HW4,       GPIO_PC(11),    GPIOF_DEVICE(0b00))

/* uart0_cts */
DEFINE_GPIO(BT_CTS_HW4,       GPIO_PC(12),    GPIOF_DEVICE(0b00))

/* uart0_rts */
DEFINE_GPIO(BT_RTS_HW4,       GPIO_PC(13),    GPIOF_DEVICE(0b00))
